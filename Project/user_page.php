...
$nextWeek = date('Y-m-d', strtotime('+6 days')); // Date after 6 days
        ...
        <table>
            <thead>
                <tr>
                    <th>Name</th>
                    <?php
                    //ensures that the schedule is consistently up to date with the actual calender
                    for ($i = 0; $i < 7; $i++) {
                        $currentDate = date('Y-m-d', strtotime($today . " +$i days"));
...
<script>
    //properly displays the calender on the user page
