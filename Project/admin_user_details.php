...
<head>
    ...
    <!-- two functions used to check if valid date and time when making availability -->
    <script>
...
<body>
    ...
    <!-- form for creating availability -->
    <div class="main-content">
        <h1 class="shift-sync-title">Shift Sync</h1>
        <p class="tagline">Your Personal Shift Details</p>
        <form class="availability-form" action="admin_save_availability.php" method="POST" onsubmit="return validateDate() && validateTimes()">
